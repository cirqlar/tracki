...
export default function Index() {
  return (
    <DefaultLayout mainClasses="flex flex-col items-center justify-center">
      ...
      <Link href="/setup">
        <a className="bg-green-500 rounded uppercase text-white py-2 px-4 text-lg sm:text-xl mt-5 inline-block">Begin</a>
      </Link>
      <a className="underline text-base mt-4 font-light">Already have an account?</a>
    </DefaultLayout>
  );
}
